...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsSignSignApp = __webpack_require__(227);

	var _componentsSignSignApp2 = _interopRequireDefault(_componentsSignSignApp);

	var _componentsSignSignIn = __webpack_require__(228);

	var _componentsSignSignIn2 = _interopRequireDefault(_componentsSignSignIn);

	var _componentsSignSignUp = __webpack_require__(229);

	var _componentsSignSignUp2 = _interopRequireDefault(_componentsSignSignUp);

	var store = (0, _storeConfigureStore2['default'])();

	var routes = _react2['default'].createElement(
	    _reactRouter.Route,
	    { name: 'auth', path: '/auth', handler: _componentsSignSignApp2['default'] },
	    _react2['default'].createElement(_reactRouter.Route, { name: 'authSignIn', path: 'signin', handler: _componentsSignSignIn2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { name: 'authSignUp', path: 'signup', handler: _componentsSignSignUp2['default'] })
	);

	_reactRouter2['default'].run(routes, _reactRouter.HistoryLocation, function (Handler, routerState) {
	    _react2['default'].render(_react2['default'].createElement(
	        _reactRedux.Provider,
	        { store: store },
	        function () {
	            return _react2['default'].createElement(Handler, { routerState: routerState });
	        }
	    ), document.body);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduces = __webpack_require__(217);
	...
	var finalCreateStore = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2['default'], logger),
	//devTools(),
	_redux.createStore);

	function configureStore(initialState) {
	    return finalCreateStore(_reduces2['default'], initialState);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userReducer = __webpack_require__(218);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function () {
	    ...
	    switch (action.type) {
	        case _actionsUserActions.DO_SIGNIN:
	            return _immutable2['default'].fromJS(action.data);
	        case _actionsUserActions.USER_INFO:
	            return _immutable2['default'].fromJS(action.data);
	        default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DO_SIGNIN = 'DO_SIGNIN';
	exports.DO_SIGNIN = DO_SIGNIN;
	var DO_SIGNUP = 'DO_SIGNUP';
	...
	function signIn(params) {
	    return function (dispatch) {
	        _superagent2['default'].post('/api/auth/signin').send(params).end(function (err, resp) {
	...
	function signUp(params) {
	    return function (dispatch) {
	        _superagent2['default'].post('/api/auth/signup').send(params).end(function (err, resp) {
	...
	function signOut() {
	    return function (dispatch) {
	        _superagent2['default'].del('/api/auth/signout').end(function (err, resp) {
	...
	function getUser() {
	    return function (dispatch) {
	        _superagent2['default'].post('/api/user').end(function (err, resp) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createLogger = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SignApp = (function (_React$Component) {
	    _inherits(SignApp, _React$Component);

	    function SignApp() {
	        _classCallCheck(this, SignApp);

	        _get(Object.getPrototypeOf(SignApp.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(SignApp, [{
	        key: 'render',
	        value: function render() {
	    ...
	    return {
	        action: {
	            signIn: function signIn(params) {
	                return dispatch((0, _actionsUserActions.signIn)(params));
	            }
	        }
	    };
	}

	exports['default'] = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(SignApp);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SingIn = (function (_Component) {
	    _inherits(SingIn, _Component);

	    function SingIn(props) {
	        _classCallCheck(this, SingIn);

	        _get(Object.getPrototypeOf(SingIn.prototype), 'constructor', this).call(this, props);
	        this.state = {
	            formValue: {
	                account: '',
	                password: ''
	    ...
	    _createClass(SingIn, [{
	        ...
	        value: function onChange(e) {
	            var value = this.state.formValue;
	            value[e.target.name] = e.target.value;
	            this.setState({ formValue: value });
	        }
	    }, {
	        key: 'onEnterToSignIn',
	        value: function onEnterToSignIn(e) {
	            if (e.keyCode === 13) {
	                this.onSignIn(e);
	            }
	        }
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement('input', { tab: '1', type: 'text', className: 'form-control', name: 'account', placeholder: '邮箱',
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement('input', { tab: '2', type: 'password', className: 'form-control', name: 'password', placeholder: '密码',
	                            onChange: this.onChange.bind(this) })
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        ...
	                        _react2['default'].createElement(
	                            'button',
	                            { type: 'button', className: 'btn btn-primary btn-block', onClick: this.onSignIn.bind(this) },
	                            '登录'
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CAPTCHA_URI = '/api/auth/captcha';
	...
	var SingUp = (function (_Component) {
	    ...
	    function SingUp(props) {
	        ...
	        _get(Object.getPrototypeOf(SingUp.prototype), 'constructor', this).call(this, props);
	        this.state = {
	            formValue: {
	                account: '',
	                password: '',
	    ...
	    _createClass(SingUp, [{
	        ...
	        value: function isFormDisabled() {
	            ...
	            return formValidation.account.length + formValidation.password.length + formValidation.password2.length + formValidation.captcha.length > 0;
	        }
	    }, {
	        key: 'onSignUp',
	        value: function onSignUp(e) {
	            ...
	            var disabled = this.isFormDisabled();
	            if (!disabled) {
	        ...
	        key: 'onEnterToSignUp',
	        value: function onEnterToSignUp(e) {
	            if (e.keyCode === 13) {
	                this.onSignUp(e);
	            }
	        }
	    }, {
	        key: 'onRefreshCaptcha',
	        value: function onRefreshCaptcha(e) {
	            e.preventDefault();
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'form-group' },
	                        _react2['default'].createElement('input', { type: 'text', className: 'form-control', name: 'account', placeholder: '邮箱',
	                            onChange: this.onChange.bind(this) }),
	                        _react2['default'].createElement(
	                            'span',
	                            { className: 'text-danger text-right' },
	                            this.state.formValidation.account
	                        )
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'form-group' },
	                        _react2['default'].createElement('input', { type: 'password', className: 'form-control', name: 'password', placeholder: '密码',
	                            onChange: this.onChange.bind(this) }),
	                        _react2['default'].createElement(
	                            'span',
	                            { className: 'text-danger text-right' },
	                            this.state.formValidation.password
	                        )
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'form-group' },
	                        _react2['default'].createElement('input', { type: 'password', className: 'form-control', name: 'password2', placeholder: '确认密码',
	                            onChange: this.onChange.bind(this) }),
	                        _react2['default'].createElement(
	                            'span',
	                            { className: 'text-danger text-right' },
	                            this.state.formValidation.password2
	                        )
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        ...
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement(
	                                'a',
	                                { href: 'javascript:;', onClick: this.onRefreshCaptcha.bind(this) },
	                                _react2['default'].createElement('img', { src: CAPTCHA_URI, className: 'col-xs-6' })
	                            ),
	                            _react2['default'].createElement(
	                                'div',
	                                { className: 'col-xs-6' },
	                                ...
	                                _react2['default'].createElement('input', { tag: '3', className: 'form-control', name: 'captcha', placeholder: '点击图片刷新验证码',
	                                    onKeyUp: this.onEnterToSignUp.bind(this), onChange: this.onChange.bind(this) }),
	                                _react2['default'].createElement(
	                                    'span',
	                                    { className: 'text-danger text-right' },
	                                    this.state.formValidation.captcha
	                                )
	                            )
	                        )
	                    ),
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement(
	                            'button',
	                            { type: 'button', className: 'btn btn-primary btn-block', disabled: disabled,
